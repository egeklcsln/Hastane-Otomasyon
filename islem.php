...
if(isset($_POST['kullanicikaydet'])){
    ...
    $sorgu=$baglanti->prepare('INSERT INTO kullanici SET
    kullanici_tc=?,
    kullanici_adsoyad=?,
    kullanici_password=?
    ');
...
if(isset($_POST['giris_yap'])){
    ...
    WHERE kullanici_tc=:kullanici_tc and kullanici_password=:kullanici_password"
    );
    $sorgu->execute([
...
if(isset($_POST['randevu_kaydet'])){
    ...
    $kaydet=$baglanti->prepare("INSERT INTO randevu SET
    randevu_sehir=?,
    randevu_hastane=?,
    randevu_doktor=?,
    randevu_tarih=?,
